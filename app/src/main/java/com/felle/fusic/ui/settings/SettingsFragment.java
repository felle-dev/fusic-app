package com.felle.fusic.ui.settings;
...
import com.felle.fusic.databinding.FragmentSettingsBinding;
...
public class SettingsFragment extends Fragment {
    ...
    private void openEmailFeedback() {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Fusic App Feedback");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Hi Fusic Team,\n\nI'd like to share my feedback:\n\n");
